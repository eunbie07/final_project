...
"""
    ...
    print("- README.md")
    print("- analyzer/__init__.py")
    print("- analyzer/room_analyzer.py")
    print("- templates/room_analyzer.html")
    print("- uploads/ (디렉토리)")
    print("- results/ (디렉토리)")
    print("- static/css/ (디렉토리)")
    print("- static/js/ (디렉토리)")
