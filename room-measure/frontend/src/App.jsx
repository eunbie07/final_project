...
const HelpTips = ({ isOpen, onClose }) => (
  ...
  >
    <div className="bg-white rounded-xl p-6 shadow-xl max-w-lg mx-4 relative">
      ...
      <h3 className="font-semibold text-gray-700 mb-4 text-lg">측정 가이드</h3>
      <div className="space-y-3">
        <div className="bg-pink-50/50 p-3 rounded-lg">
          <div className="font-medium text-gray-700 mb-1">최적의 방 형태</div>
        ...
        <div className="text-center mb-8 md:mb-12">
          ...
          <div className="flex items-center justify-center gap-2">
            <p className="text-gray-600 text-base sm:text-lg max-w-2xl">
              Measure accurate room dimensions from a single photo using
                            ...
                            <div className="space-y-2 text-sm">
                              <div className="flex justify-between">
                                ...
                                <span className="font-medium">
                                  {(manualResult.width_cm / 100).toFixed(1)}m
                                </span>
                              </div>
                              <div className="flex justify-between">
                                <span>Depth:</span>
                                <span className="font-medium">
                                  {(manualResult.depth_cm / 100).toFixed(1)}m
                                </span>
                              </div>
                              <div className="flex justify-between">
                                <span>Area:</span>
                                <span className="font-medium">
                                  {(
                                    (manualResult.width_cm *
                                      manualResult.depth_cm) /
                                    10000
                                  ).toFixed(1)}
                                  ㎡
                                </span>
                              ...
                              <div className="flex justify-between">
                                ...
                                <span className="font-medium">
                                  {(manualResult.confidence * 100).toFixed(0)}%
                                </span>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="bg-white rounded-lg p-4 border-2 border-blue-200">
                            ...
                            <div className="space-y-2 text-sm">
                              <div className="flex justify-between">
                                <span>Width:</span>
                                <span className="font-medium">
                                  {(autoResult.width_cm / 100).toFixed(1)}m
                                </span>
                              </div>
                              <div className="flex justify-between">
                                <span>Depth:</span>
                                <span className="font-medium">
                                  {(autoResult.depth_cm / 100).toFixed(1)}m
                                </span>
                              </div>
                              <div className="flex justify-between">
                                <span>Area:</span>
                              ...
                              <div className="flex justify-between">
                                <span>Confidence:</span>
                                <span className="font-medium">
                                  {(autoResult.confidence * 100).toFixed(0)}%
                                </span>
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="mt-4 p-4 bg-gray-50 rounded-lg">
                          ...
                          <div className="grid grid-cols-3 gap-4 text-sm">
                            ...
                            <div>
                              ...
                              <span className="ml-2 font-medium">
                                {Math.abs(
                                  (autoResult.width_cm * autoResult.depth_cm -
                                    manualResult.width_cm *
                                      manualResult.depth_cm) /
                                    10000
                                ).toFixed(2)}
                      ...
                      <h3 className="text-xl font-bold mb-3 text-gray-800">
                        ...
                        {result?.detectionMethod && (
                          <span className="ml-3 text-sm font-normal">
                            (
                            {result.detectionMethod === "auto"
                              ? "🤖 RoomNet Auto-Detection"
                              : "📍 Manual 4-Point"}
                            )
                          </span>
                        )}
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-gray-600 mb-1">
                              천장 높이 기준으로 상대적 깊이를 절대적 크기로
                              변환
                            </p>
                            <div className="text-xs text-gray-500 bg-pink-50 p-2 rounded">
                              • 스케일 팩터 팩터 계산 • 비례 관계 적용 • 오차
                              보정
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="text-center p-3 bg-pink-100 rounded-lg">
                          <div className="text-xl font-bold text-pink-700">
                            {(
                              (result.width_cm * result.depth_cm) /
                              10000
                            ).toFixed(1)}
                            ㎡
                          </div>
                    ...
                    <div className="bg-gradient-to-r from-pink-50 to-rose-50 rounded-lg p-4 shadow-sm border border-pink-200">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <ul className="text-sm text-pink-700 space-y-1">
                            <li>
                              • Circular or polygonal rooms may be inaccurate
                            </li>
                      ...
                      <div className="mt-3 p-3 bg-white bg-opacity-50 rounded border border-pink-300">
                        <p className="text-xs text-pink-800">
                          <strong>Tip:</strong> For more accurate measurements,
                          take photos from angles where room corners are clearly
                          visible, and ensure furniture doesn't block the walls.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="relative">
                      <div className="absolute top-4 left-1/2 transform -translate-x-1/2 z-50">
                        <button
                          onClick={() => {
                            const element =
                              document.querySelector(".room-3d-viewer");
                            if (element.requestFullscreen) {
                              element.requestFullscreen();
                            } else if (element.webkitRequestFullscreen) {
                              element.webkitRequestFullscreen();
