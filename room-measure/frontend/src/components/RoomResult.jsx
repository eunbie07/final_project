      ...
      {result.warning && (
        <div className="mb-6 p-4 bg-danger border border-danger rounded-lg">
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium text-white"><strong>주의사항</strong></span>
          </div>
          ...
          <div className="mt-6 p-6 border border-border rounded-xl bg-surface shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <div className="bg-surface p-4 rounded-lg border border-border shadow-sm">
                <div className="text-sm text-text-secondary mb-1"><strong>가로 (Width)</strong></div>
              ...
              <div className="bg-surface p-4 rounded-lg border border-border shadow-sm">
                <div className="text-sm text-text-secondary mb-1"><strong>세로 (Depth)</strong></div>
                <div className="text-2xl font-bold text-primary mb-1">
                  {depth?.toFixed(1)} cm
                </div>
                <div className="text-sm text-text-secondary">
              ...
              <div className="bg-surface p-4 rounded-lg border border-border shadow-sm">
                <div className="text-sm text-text-secondary mb-1"><strong>높이 (Height)</strong></div>
                <div className="text-2xl font-bold text-primary mb-1">
                  {height?.toFixed(1)} cm
                </div>
                <div className="text-sm text-text-secondary">
            ...
            <div className="bg-surface p-4 rounded-lg border shadow-sm mb-6">
              <h3 className="text-lg font-semibold mb-3 text-text-primary"><strong>면적 및 부피</strong></h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="text-center p-3 bg-background rounded-lg">
                  <div className="text-sm text-text-secondary mb-1"><strong>제곱미터</strong></div>
                  <div className="text-xl font-bold text-primary">
                    {area_m2.toFixed(2)} ㎡
                  </div>
                </div>
                <div className="text-center p-3 bg-background rounded-lg">
                  <div className="text-sm text-text-secondary mb-1"><strong>평수</strong></div>
                  <div className="text-xl font-bold text-primary">
                    {area_pyeong.toFixed(1)} 평
                  </div>
                </div>
                <div className="text-center p-3 bg-background rounded-lg">
                  <div className="text-sm text-text-secondary mb-1"><strong>부피</strong></div>
                  <div className="text-xl font-bold text-primary">
                    {volume_m3.toFixed(2)} ㎥
                  </div>
                </div>
            ...
            <div className="mt-6 p-4 bg-background border border-border rounded-lg">
              <div className="flex items-start gap-2">
                ...
                <div>
                  <div className="font-medium text-text-primary mb-1"><strong>참고사항</strong></div>
